...
REQUIRED_FILES = ["docs/V9_BACKEND_FLOW_CONSISTENCY.md", "src/services/v92_backend_flow_service.py", "src/api/routes/architecture.py", "src/api/routes/data_import.py", "src/api/routes/modules/__init__.py", "src/api/routes/health.py", "src/api/routes/modules/agents.py", "web_demo/index.html"]
