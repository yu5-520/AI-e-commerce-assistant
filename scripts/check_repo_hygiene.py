...
STATIC_MUST_CONTAIN = {
    "README.md": ["V12.9.0", "task_lifecycle_state_machine_service", "operator_accepted", "upsert"],
    "src/api/routes/modules/todo.py": ["TODO_VERSION = \"12.9.0\"", "transition_lifecycle_task", "lifecycle_state_summary", "task_lifecycle_state_machine_service"],
    "src/services/task_lifecycle_state_machine_service.py": ["TASK_LIFECYCLE_STATE_MACHINE_VERSION = \"12.9.0\"", "operator_accepted", "project_lifecycle_task", "mirror_all"],
    "src/services/task_lifecycle_orchestrator_service.py": ["TASK_LIFECYCLE_VERSION = \"12.9.0\"", "等待自动复盘", "recap_scheduled"],
    "src/services/v106_task_action_simplifier.py": ["V106_TASK_ACTION_VERSION = \"12.9.0\"", "one_current_human_action_per_task_card", "system_recap_stays_out_of_human_task_cards"],
    "src/services/task_report_service.py": ["REPORT_VERSION = \"12.9.0\"", "TASK_LIFECYCLE_STATE_MACHINE_VERSION", "get_lifecycle_task_projection"],
    "src/api/routes/modules/task_report.py": ["TASK_REPORT_ROUTE_VERSION = \"12.9.0\"", "生命周期状态机"],
    "web_demo/modules/todo/page.js": ["TASK CENTER · V12.9.0", "applyTransitionResult", "v129-task-transition", "data-submit"],
...
FORBIDDEN_CONTAINS = {
    ...
    "src/api/routes/modules/todo.py": ["TODO_VERSION = \"12.8.1\"", "_memory_or_repo_transition"],
    "src/services/v106_task_action_simplifier.py": ["V106_TASK_ACTION_VERSION = \"10.6.0\"", "one_secondary_action_allowed"],
