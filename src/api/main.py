...
app = FastAPI(
    ...
    version="4.3.0",
    description="V4.3 runtime with vertical category creative Agent for title, main-image, selling-point, and A/B test planning.",
)
...
def index() -> Any:
    ...
    return {"message": "AI ERP Operating Advisor API is running.", "version": "4.3.0"}
