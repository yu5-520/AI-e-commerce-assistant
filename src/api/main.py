...
app = FastAPI(
    ...
    version=API_VERSION,
    description="V5.3.0 runtime with PostgreSQL / Alembic production data model scaffold, Nginx deployment templates, security headers, API rate limit, LLM Gateway controls, JSON TechLog redaction, trace_id audit chain, ARQ dispatch fallback, UserContext, and architecture APIs.",
)
