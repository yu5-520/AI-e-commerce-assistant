...
from src.api.routes import accounts, approvals, architecture, audit, data_import, data_source_compat, deprecated_stations, health, import_jobs, llm, modules, ops, pipeline, report_task_sync, station_handoffs, stations, system, task_persistence, trends, v10_product, v9_readiness, worker_jobs
...
STATION_MAINLINE = {
    ...
    "mode": "agent_guided_snapshot_task_handoff",
    "rule": "V13.1：经营快照完成后只交接到任务判断线；任务是否生成必须经过RAG参照和Agent判断，不恢复旧Hook。",
}
...
def index() -> Any:
    ...
    return {"message": "AI ERP Operating Advisor API is running.", "version": API_VERSION, "v13_1": "agent_guided_snapshot_task_handoff", "stationMainline": STATION_MAINLINE}
