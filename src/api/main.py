...
app = FastAPI(title="AI ERP Operating Advisor API", version=API_VERSION, description="V8.6 runtime: cross-validated weight readiness for product, store, and operator decisions.")
...
def apply_v86_runtime_cleanup() -> None:
