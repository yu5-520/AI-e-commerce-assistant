...
app = FastAPI(
    ...
    version="3.0.0",
    description="V3 report-driven data refresh API with data snapshots, alert events, task generation, and cross-account lifecycle sync.",
)
...
def index() -> Any:
    ...
    return {"message": "AI ERP Operating Advisor API is running.", "version": "3.0.0"}
