...
app = FastAPI(title="AI ERP Operating Advisor API", version=API_VERSION, description="V8.9 runtime: weight execution feedback, after-action review, and RAG memory candidates.")
...
def apply_v89_runtime_cleanup() -> None:
