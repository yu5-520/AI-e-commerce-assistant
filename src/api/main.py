...
app = FastAPI(
    ...
    version="5.0.4",
    description="V5.0.4 runtime with data-driven owner, manager, operating-unit, and dashboard pages.",
)
...
def index() -> Any:
    ...
    return {"message": "AI ERP Operating Advisor API is running.", "version": "5.0.4"}
