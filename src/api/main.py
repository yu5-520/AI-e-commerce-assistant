...
app = FastAPI(
    ...
    version="5.0.5",
    description="V5.0.5 runtime with decision task drafts, supplement fields, and path-based review flow.",
)
...
def index() -> Any:
    ...
    return {"message": "AI ERP Operating Advisor API is running.", "version": "5.0.5"}
