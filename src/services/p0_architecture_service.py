...
P0_LAYERS: list[dict[str, Any]] = [
    ...
    {"id": "P0-5", "name": "PostgreSQL 数据模型", "status": "import_worker_hybrid_mirror_ready", "target": "PostgreSQL + Alembic", "currentGap": "ImportJob / WorkerJob upsert 已补齐。"},
    ...
    {"id": "P0-8", "name": "Audit / TechLog", "status": "repository_transition", "target": "audit_logs / tech_logs", "currentGap": "读层已存在，写层待后续 mirror。"},
