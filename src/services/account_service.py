...
ROLES: List[Dict[str, Any]] = [
    ...
    {"id": "operator", "name": "运营账号", "level": 3, "scope": "被分配店铺", "insightDepth": "store_operation", "insightName": "店铺运营视角", "description": "管理自己被授权的店铺，查看经营单元、报表、商品、竞品、上新、流量、待办和日志。", "permissions": ["view_managed_stores", "view_own_tasks", "handle_tasks", "submit_tasks", "view_only"], "visibleModules": OPERATOR_MODULES, "allowedActions": ["查看负责店铺", "查看店铺报表", "处理商品 / 竞品 / 上新 / 流量任务", "提交处理结果", "提交运营日志"], "hiddenFields": ["全部店群", "其他运营店铺", "全局财务利润", "组织权限调整", "总管派发复核台"], "managementInsights": ["我的店铺", "我的报表", "我的商品", "我的流量", "我的待办", "我的日志"]},
