...
This service is the current backend source of truth for module demo data.
Frontend `mock-data.js` is intentionally kept as a minimal fallback so the same
business dataset is not maintained twice.
"""
