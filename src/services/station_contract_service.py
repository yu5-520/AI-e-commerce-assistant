"""V14.2 standard station contract service."""
...
STATION_CONTRACT_VERSION = "14.2.0"
...
DEFAULT_OUTPUTS = {
    ...
    "product_signal_snapshot_station": ["productSignalCount", "productSignalSnapshotRef", "outputRef"],
...
def run_station_contract(station_id: str, body: Dict[str, Any] | None = None, *, diagnostic: bool = False) -> Dict[str, Any]:
    ...
    data_version = adapter_output.get("dataVersion") or body.get("dataVersion") or body.get("data_version") or ("DIAG-V14.2" if diagnostic else None)
