...
def security_status(ctx: UserContext) -> Dict[str, Any]:
    ...
    return {
        ...
        "database": {
            ...
            "ormBase": orm_base_summary(),
            "models": model_registry_summary(),
            "repositories": repository_runtime_summary(ctx),
            "alembic": {"enabled": True, "config": "alembic.ini", "versionsPath": "alembic/versions"},
        },
