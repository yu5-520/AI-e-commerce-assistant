"""V14.7 clean business station registry."""

from __future__ import annotations

from typing import Any, Dict, List

STATION_REGISTRY_VERSION = "14.7.0"
...
STATIONS: List[Dict[str, Any]] = [
    ...
    station("product_signal_snapshot_station", "full_product_bundle_ready", "商品全量包整合站", "src.services.product_signal_snapshot_service", "full_product_bundle", "task_signal_station", "snapshot_signal_line", "full_product_bundle"),
    station("task_signal_station", "full_product_bundle_queued", "商品全量包队列站", "src.services.signal_pool_service", "signal_pool", "rag_context_station", "agent_task_judgment_line", "task_signal"),
    station("rag_context_station", "rag_volatility_context_ready", "RAG波动边界上下文站", "src.services.rag_context_station_service", "rag_context", "agent_judgment_station", "agent_task_judgment_line", "rag_context"),
    station("agent_judgment_station", "agent_soft_routing_ready", "Agent商品经营诊断站", "src.services.agent_judgment_station_service", "agent_judgment", "task_snapshot_station", "agent_task_judgment_line", "agent_judgment"),
    station("task_snapshot_station", "task_snapshot_ready", "SOP任务快照站", "src.services.task_snapshot_station_service", "task_snapshot", "task_pool_station", "agent_task_judgment_line", "task_snapshot"),
