...
def model_registry_summary() -> dict[str, object]:
    return {
        ...
        "models": [
            "Tenant", "Organization", "User", "Store", "ImportJob", "ProjectionJob",
            "DecisionTask", "TaskEvent", "TaskEvidence", "WorkerJob", "AuditLog",
            "TechLog", "LLMGatewayEvent",
        ],
        "rule": "Models are production schema targets for Alembic; current Demo SQLite services remain unchanged until migration is explicit.",
    }
