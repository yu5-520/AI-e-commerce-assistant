...
V14.8 keeps the original repository helper surface and adds WAL/busy_timeout so
frontend read-model SELECT calls are less likely to block behind worker writes.
"""
