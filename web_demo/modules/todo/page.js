  ...
  window.TodoPage = {
    ...
    mount(ctx) {
      ...
      ctx.delegate("[data-assign]", "click", async (_, node) => {
        ...
        await AppApi.assignTodo(node.dataset.assign, { note: "当前账号拆分任务给运营账号" });
