(function () {
  ...
  window.TrendCenterPage = {
    ...
    async render() {
      ...
      return `<section class="report-hero report-hero-clean"><div><p class="eyebrow">TREND CENTER · V6.6</p><h2>动态数据趋势中心</h2></div><div class="report-hero-side"><span>当前阶段</span><strong>审批生命周期</strong><small>审批通过后再执行</small></div></section>${metrics(data)}${budgetBlock(data)}${approvalBlock(data)}${riskTasks(data)}`;
    },
    mount(ctx) {
